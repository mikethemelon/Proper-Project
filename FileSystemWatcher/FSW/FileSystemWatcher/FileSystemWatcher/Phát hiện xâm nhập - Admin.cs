...
namespace FileSystemWatcher
{
    public partial class MDIParent1 : Form
    {
        ...
        private void máyTínhToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            SetParent(calc.MainWindowHandle, this.Handle);
        }
        ...
        private void fileSystemManagerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FileSystemMonitor childForm = new FileSystemMonitor();
            childForm.MdiParent = this;
            childForm.Show();
        }
